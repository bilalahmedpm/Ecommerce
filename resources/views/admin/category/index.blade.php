...
<tr>
    <td>{{$row->id}}</td>
    <td>{{$row->name}}</td>
    <td><a href="{{route('category.edit' , $row->id)}}" data-toggle="modal" data-target="#exampleModal{{$row->id}}" class="btn btn-sm btn-primary" data-toggle="tooltip" title="edit">
                        ...
                        <form action="{{route('category.update',$row->id)}}" method="post" enctype="multipart/form-data" data-parsley-validate>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text"  value="{{$row->name}}" name="name" required placeholder="Category Name" class="form-control">
                                </div>
                            </div>
